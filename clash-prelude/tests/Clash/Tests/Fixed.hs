...
enumTests =
  testGroup "Enum"
    [ testEnumProperties "SFixed 0 0" (Proxy @(SFixed 0 0))
    , testEnumProperties "SFixed 0 1" (Proxy @(SFixed 0 1))
    , testEnumProperties "SFixed 1 0" (Proxy @(SFixed 1 0))
    , testEnumProperties "SFixed 0 2" (Proxy @(SFixed 0 2))
    , testEnumProperties "SFixed 1 1" (Proxy @(SFixed 1 1))
    , testEnumProperties "SFixed 2 0" (Proxy @(SFixed 2 0))
    , testEnumProperties "SFixed 1 2" (Proxy @(SFixed 1 2))
    , testEnumProperties "SFixed 2 1" (Proxy @(SFixed 2 1))
    , testEnumProperties "SFixed 2 2" (Proxy @(SFixed 2 2))
    ...
    , testEnumProperties "UFixed 0 0" (Proxy @(UFixed 0 0))
    , testEnumProperties "UFixed 0 1" (Proxy @(UFixed 0 1))
    , testEnumProperties "UFixed 1 0" (Proxy @(UFixed 1 0))
    , testEnumProperties "UFixed 0 2" (Proxy @(UFixed 0 2))
    , testEnumProperties "UFixed 1 1" (Proxy @(UFixed 1 1))
    , testEnumProperties "UFixed 2 0" (Proxy @(UFixed 2 0))
    , testEnumProperties "UFixed 1 2" (Proxy @(UFixed 1 2))
    , testEnumProperties "UFixed 2 1" (Proxy @(UFixed 2 1))
    , testEnumProperties "UFixed 2 2" (Proxy @(UFixed 2 2))
